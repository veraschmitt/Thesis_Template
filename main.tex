...
\input{2_literature_rev/2.0_intro.tex}
\subsection{First subsection....}
\input{2_literature_rev/2.1_subsection.tex}
\subsection{Second Subsection...}
\input{2_literature_rev/2.2_subsection.tex}
%conclusion does not require own subtitle 
\input{2_literature_rev/2.3_conclusion.tex}
\newpage
\end{spacing}
\begin{spacing}{1}
%\input{long_table_example.tex} % This is the example table of the literature review
\end{spacing}
%\clearpage
%\newpage
...
\section{Methodology} 
\input{3_methodology/3.0_intro.tex}
...
\input{3_methodology/3.1_first_subsection.tex}
...
\section{Results}
\input{4_Results/4.0_intro}
\subsection{First Subsection Tile}
\input{4_Results/4.1_first_subsection.tex}
...
\section{Discussion}
\input{5_Discussion/5.0_intro.tex}
...
\section{Conclusion}
\input{6_Conclusion/6.0_intro.tex}
...
\input{6_Conclusion/6.3_examples}
